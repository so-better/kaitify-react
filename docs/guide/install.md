...
- 下载地址：[kaitify-react](https://registry.npmmirror.com/@kaitify/react/download/@kaitify/react-0.0.1-beta.11.tgz)
...
```html
<!-- 引入固定版本的kaitify -->
<script src="https://unpkg.com/@kaitify/react@0.0.1-beta.11/lib/kaitify-react.umd.js"></script>
<!-- 始终引入最新的kaitify -->
...
# 安装指定版本
npm install @kaitify/react@0.0.1-beta.11
```
...
# 安装指定版本
yarn install @kaitify/react@0.0.1-beta.11
```
...
# 安装指定版本
pnpm install @kaitify/react@0.0.1-beta.11
```
